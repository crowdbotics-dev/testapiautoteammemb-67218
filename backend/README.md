...
## Project Structure
    ...
    ├── testapiautoteammemb_67218  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_67218`
...
2. Clone this repo and `cd testapiautoteammemb_67218`
